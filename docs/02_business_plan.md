# Tsunagu Business Plan（Working Draft｜2025-10-20）
...
- **プラン別機能と価格**
  ...
  | Growth | ¥25,000 | 重複検知、タレントプール、LINE/Chatwork/SMS通知、Explainability、API | 3.5% | ¥630,000 |
  | Enterprise | 見積 | 専任CS、SAML/SCIM、SLA99.9%、API上限UP | 3%〜 | ¥1,200,000+ |
- **成果報酬モデル**
...
- **ターゲットセグメント別アプローチ**
  ...
  | スタートアップCTO/HR | 高速選考、データ可視化 | Explainability、重複検知、API連携 | AI提案採用率、面接所要時間 |
  | 紹介エージェント | 成果報酬管理、透明性 | エージェントポータル、決済自動化、信頼スコア | GMV、報酬回収期間 |
- **チャネル / パートナー**
...
- **コスト構造**
  - **Cogs**: Stripe/決済手数料、OpenAI/モデル推論、KYCベンダー費用。
  - **Opex**: 人件費（開発/CS/営業）、マーケ/広告、法務・監査、サーバー・サードパーティSaaS。
  - **採用計画**: FY26に開発+CS中心6名、FY27にセールス/マーケ3名、FY28にパートナーアライアンス2名追加。

## 6. Risk Management
| リスク | タイプ | 影響 | 初期対策 | 2nd プラン |
| --- | --- | --- | --- | --- |
...
- **フェーズと主なマイルストーン**
  ...
  | Growth | 2026-04-01〜09-30 | エージェント発注、AMLルール、Explainabilityダッシュボード、API GA | 有料社数50→120、NPS +25 |
  | Network | 2026-10-01〜2027-03-31 | マーケットプレイス、Payroll/EOR連携、離職予測 | GMV ¥3.5B、GRR 90% |
- **投資回収計画**
